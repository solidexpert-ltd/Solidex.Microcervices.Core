...
namespace Microcervices.Core.Api
{
    public abstract class AnticaptchaBase
    {
        ...
        public bool CreateTask()
        {
            ...
            var postResult = JsonPostRequest(ApiMethod.CreateTask, jsonPostData);
        ...
        public bool WaitForResult(int maxSeconds = 120, int currentSecond = 0)
        {
            ...
            var postResult = JsonPostRequest(ApiMethod.GetTaskResult, jsonPostData);
        ...
        public double? GetBalance()
        {
            ...
            var postResult = JsonPostRequest(ApiMethod.GetBalance, jsonPostData);
